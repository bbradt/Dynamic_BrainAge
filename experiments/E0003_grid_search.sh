#!/bin/bash
experiment_name="E0003_grid_search"
criterion_=( "MSELoss" )
...
model_kwargs_=( '{"hidden_size":16}' '{"hidden_size":32}' '{"hidden_size":64}' '{"hidden_size":128}' '{"hidden_size":256}' '{"hidden_size":512}' '{"hidden_size":512}' )
