#!/bin/bash
experiment_name="E0003_ukbhcp1200valid_inference"
criterion_=( "MSELoss" )
train_dataset_=( "None" )
train_dataset_args_=( "[]" )
train_dataset_kwargs_=( '{"N_subs":5885}' )
test_dataset_=( "ukbhcp1200valid" )
test_dataset_args_=( "[]" )
test_dataset_kwargs_=( '{"N_subs":5885,"N_timepoints":448}' )
model_=( "bilstm" )
