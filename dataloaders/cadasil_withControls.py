...
class CadasilControlData(Dataset):
    def __init__(self,
                 N_components=53,
                 N_timepoints=929,
                 N_subs=22,
                 phenotypes="/data/users2/bbaker/projects/cadasil_analysis/CADASIL_phenotypes_withcontrols.csv",
                 target_variable="age"
                 ):
...
if __name__ == "__main__":
    ...
    test_dataset = CadasilControlData(N_subs=22)
