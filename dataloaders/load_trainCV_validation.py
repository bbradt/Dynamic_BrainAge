...
class CVValid(Dataset):
    def __init__(self,
                ...
                #  window_size=40,
                 ...
                 cv_idxs_file="./experiments/E0001_cv_valid_idxs.npy",
                 fold = 0,
                #  age_threshold=15
        ...
        cv_idxs = np.load(cv_idxs_file)
        np.random.seed(319)
        self.idxs = np.random.permutation(len(all_data))[cv_idxs[fold,:N_subs]] # get all data in that fold of cv
...
if __name__ == "__main__":
    ...
    test_dataset = CVValid(N_subs=20, k=1)
