...
class UKBHCP1200DataValid(Dataset):
    def __init__(self,
                 N_components=53,
                 N_timepoints=448,
                #  window_size=40,
        ...
        np.random.seed(319)
        self.idxs = np.random.permutation(len(all_data))[-N_subs:] # get all data not in training set
...
if __name__ == "__main__":
    ...
    test_dataset = UKBHCP1200DataValid(N_subs=20)
